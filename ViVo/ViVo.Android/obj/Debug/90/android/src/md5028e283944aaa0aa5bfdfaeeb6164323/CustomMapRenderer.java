...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ViVo.Droid.Renderers.CustomMapRenderer, ViVo.Android", CustomMapRenderer.class, __md_methods);
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("ViVo.Droid.Renderers.CustomMapRenderer, ViVo.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("ViVo.Droid.Renderers.CustomMapRenderer, ViVo.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public CustomMapRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("ViVo.Droid.Renderers.CustomMapRenderer, ViVo.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
